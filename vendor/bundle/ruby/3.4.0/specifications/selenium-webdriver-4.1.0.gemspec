...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<childprocess>.freeze, [">= 0.5".freeze, "< 5.0".freeze])
  s.add_runtime_dependency(%q<rexml>.freeze, ["~> 3.2".freeze, ">= 3.2.5".freeze])
  s.add_runtime_dependency(%q<rubyzip>.freeze, [">= 1.2.2".freeze])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.8.0".freeze])
