...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/vcr/vcr/blob/v6.4.0/CHANGELOG.md", "funding_uri" => "https://opencollective.com/vcr" } if s.respond_to? :metadata=
